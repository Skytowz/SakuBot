...
module.exports.run = async(client, interaction) =>{        
	if (!["904895756073336873", "273756946308530176","1020030218154557611","1022927961613148190"].includes(interaction.member.id)) return interaction.reply({ content: 'Tu ne peux pas utiliser cette commande', ephemeral: true });
